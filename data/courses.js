...
(() => {
    ...
    const courses = [

        {
            ...
            description: "Build a strong programming foundation by learning variables, data types, logic, control flow, functions, problem solving and core programming concepts.",
            outcome: "Understand how programs work and confidently solve beginner programming problems before moving into a specific language.",
            prerequisites: [
